...
canonical post-fix captures used in the evaluation. All seven are
released so v1--v5 remain available for downstream cache-LOOKUP
debugging on Llama-class backends; headline numbers exclude v1--v5. Per-capture statistics are nearly uniform (each
...
the authoritative record; all other artifacts are derivable from it.
