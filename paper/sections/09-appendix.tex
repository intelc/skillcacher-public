...
Face~\cite{claudecode-trace-hf}, available under CC-BY 4.0; the
...
(ii)~and~(iii) are released under MIT
at~\cite{skillcacher-source}; the paper PDF, prebuilt figures, and
this appendix's reproducibility scripts all live in the same
